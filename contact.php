                        ...
                        <div class="wow fadeInUp" data-wow-delay="0.2s">
                            <form method="post" action="admin/store.php">
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="g-recaptcha" data-sitekey="6LcJIJklAAAAAOGO_GLr3cbS4EmZfNeCUUJ2Rqje"></div>

                                    <div class="col-12">
                                        <button class="btn btn-primary w-100 py-3" id="submit_con" type="submit" name="contact_submit">Send Message</button>
                                    </div>
                                </div>
                            </form>
                        </div>
